...
__version__ = "$Rev: 52 $"
__date__ = "$Date: 2011-02-04 05:01:53 +0800 (五, 2011-02-04) $"
...
def interestingness(date, page=1, per_page=100):
    method = 'flickr.interestingness.getList'
    data = _doget(method, False, date=date, page=page, per_page=per_page)
    photos = []
    if isinstance(data.rsp.photos.photo , list):
        for photo in data.rsp.photos.photo:
            photos.append(_parse_photo(photo))
